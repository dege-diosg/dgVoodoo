...
_16to16_noalpha:
		...
		GetShiftCode_16to16	[ebx].RPos, [ebx].RBitCount, [edx].RPos, [edx].RBitCount
		GetShiftCode_16to16	[ebx].GPos, [ebx].GBitCount, [edx].GPos, [edx].GBitCount
		GetShiftCode_16to16	[ebx].BPos, [ebx].BBitCount, [edx].BPos, [edx].BBitCount
