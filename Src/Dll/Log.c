...
char *combfact_t[] = {	"GR_COMBINE_FACTOR_ZERO", "GR_COMBINE_FACTOR_LOCAL",
						...
						"GR_COMBINE_FACTOR_LOD_FRACTION","GR_COMBINE_FACTOR_ONE",
...
char *alphabfnc_srct[] = {
						"GR_BLEND_ZERO", "GR_BLEND_SRC_ALPHA", "GR_BLEND_DST_COLOR",
...
char *alphabfnc_dstt[] = {
						"GR_BLEND_ZERO", "GR_BLEND_SRC_ALPHA", "GR_BLEND_SRC_COLOR",
						"GR_BLEND_DST_ALPHA", "GR_BLEND_ONE", "GR_BLEND_ONE_MINUS_SRC_ALPHA",
...
char *hint_t[] = {	"GR_HINT_STWHINT", "GR_HINT_FIFOCHECKHINT", "GR_HINT_FPUPRECISION", "GR_HINT_ALLOW_MIPMAP_DITHER",
...
char *fogmodemod_t[] = {	"", "GR_FOG_MULT2", "GR_FOG_ADD2" };
